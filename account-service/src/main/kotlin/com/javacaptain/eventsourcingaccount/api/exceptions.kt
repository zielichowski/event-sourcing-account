...
sealed interface DomainError {
    ...
    data class AccountNotInitializedError(override val message: String = "Account has not been initialized") :
        DomainError
    ...
    data class InvalidTransactionIdFormat(override val message: String = "Transaction id should be in UUID format") :
        DomainError

    data class InvalidOwnerIdFormat(override val message: String = "Owner id should be in UUID format") : DomainError

    data class InvalidAccountIdFormat(override val message: String = "Account id should be in UUID format") :
        DomainError
